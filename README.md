...
- 🔭 Сейчас работаю над проектом "цветочный магазин"


- 🌱 Сейчас изучаю React, Kafka, JavaScript


- 📚 Более 3,5 года опыта работы
...
## Коротко обо мне:
Я являюсь Java backend-разработчиком с более чем 3,5-летним стажем работы. За это время я накопил обширные знания и практические навыки в таких ключевых технологиях, как Java, Spring, Spring Boot, JPA и Hibernate.
